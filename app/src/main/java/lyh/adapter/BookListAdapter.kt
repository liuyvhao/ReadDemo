...
class BookListAdapter(var mOnItemClickLitener: OnItemClickLitener, var bookLists: ArrayList<BookList>) : RecyclerView.Adapter<BookListAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_booklist, parent, false))
